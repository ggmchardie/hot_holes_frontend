    ...
    return (
      <div>
          ...
          <Card style={{ width: '18rem' }}>
            <Card.Img variant="top" src="https://i.imgur.com/WVQJBnt.jpg" />
            <Card.Body>

              <Card.Title>Jam Doughnuts</Card.Title>
                <Card.Text>
                  Fresh jam doughnuts filled with our home made, seasonal jam.
                </Card.Text>
...
export default connect(mapStateToProps, { addOrder } )(JamCard);
